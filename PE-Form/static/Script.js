const dropdownDefinitions = {
  ...
  activityExecutor: {
    ...
    options: [
      ...
      "Rakesh ShahNokia CM", "Balamurlidharan K", "Shahir Puttal", "Pramod Kumar Singh",
    ],
  },
  deployApproval: {
...
function updateSummary() {
  ...
  const peNonPe = getDropdownValue("peNonPe").join(", ") || "-";
...
function validatePayload(data) {
  ...
  if (data.peNonPe.length === 0) return "PE / Non-PE select karein.";
